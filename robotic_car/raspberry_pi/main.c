...
//Calculates control values, based on the area and position of the object, and sends them to the micro controller
...
//Checks if there is data on the socket for network communication
int instructionReceived(){
...
//Executes the instruction sent from the client
void executeInstruction(){
