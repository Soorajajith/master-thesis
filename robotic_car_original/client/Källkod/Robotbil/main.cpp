...
#define WINDOW_NAME "MindBot 1.0"
...
char* server_ip_address = "192.168.1.16";
...
int main(void){
	printf("Enter new IP or press enter to keep default (192.168.1.16): ");
	char new_ip[17] = { 0 };
	while (1){
	...
	//On exit close the network and exit program.
	closeNetwork();
	return 0;
}
